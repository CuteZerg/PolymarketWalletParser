...
from db import get_last_block, save_logs, update_last_block
...
async def index_topic_slot(w3: AsyncWeb3, pool: asyncpg.Pool, slot: int, end_block: int):
    ...
    current_block = await get_last_block(pool, source_name)
    ...
    while current_block < end_block:
        ...
        async with pool.acquire() as conn, conn.transaction():      
            ...
            await update_last_block(conn, source_name, to_block)
